...
public class ArticleService2Test {
    ...
    void givenSearchParameters_whenSearchingArticles_thenReturnsArticlePage() {
        ...
        articleRepository.findByTitle(searchKeyword,pageable);
        ...
        // Then
        assertThat(articles).isEmpty();
        then(articleRepository).should(atLeastOnce()).findByTitle(searchKeyword, pageable);
        then(articleRepository).should(atLeastOnce()).findByTitleContaining(searchKeyword, pageable);
    }
